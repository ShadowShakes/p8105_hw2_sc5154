...
* The combined dataset has `r com_row` rows and `r com_col` columns, with `r mr_row` rows of data from Mr. Trash Wheel and `r pro_row` rows of data from Professor Trash Wheel.
